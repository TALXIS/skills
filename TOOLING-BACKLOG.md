...
| T19 | The base-controls palette queryable from the CLI (control inventory, the binding each control covers, and the form-composition levels) | `prototypes` references/base-controls-palette.md (read-the-storybook workaround) | proposed |

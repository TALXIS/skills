> **Needed because:** the auth -> connection -> profile bootstrap order is not surfaced by txc help.
> **Remove when:** txc surfaces the bootstrap sequence in help/docs (T12).

> **Needed because:** privilege depth semantics and the role/privilege sequence are not surfaced by txc help.
> **Remove when:** txc surfaces sequences and privilege semantics in help/docs (T12).

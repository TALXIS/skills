---
name: pcf-controls
description: Attaches a packaged PCF control (e.g. the TALXIS Grid) to a form control via txc workspace control attach, with optional Client API scripting through a web resource. Use when overlaying a custom control on a subgrid or field, attaching the TALXIS Grid, configuring PCF control parameters, or wiring a script library to customize a control at runtime.
---

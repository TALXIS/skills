---
name: solution-layering
description: Routes components to the right solution by concern and explains managed vs unmanaged layering, including layer conflict triage. Use when deciding which solution a table, plugin, form, or security role belongs in, when choosing managed vs unmanaged for a target environment, or when a deployed component behaves unexpectedly due to layer conflicts.
---

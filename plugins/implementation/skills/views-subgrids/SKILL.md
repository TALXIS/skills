---
name: views-subgrids
description: Scaffolds Dataverse views with txc, post-patches the generated view XML to add columns (layoutxml + fetchxml), and places subgrids of related records on parent forms. Use when creating a view for a table, adding columns to a view, or adding a subgrid to a form in a TALXIS workspace.
---

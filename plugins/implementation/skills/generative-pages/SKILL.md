---
name: generative-pages
description: Scaffolds a generative page (React 17 + Fluent UI v9 custom page rendered inside a model-driven app) with pp-page-generative and wires it into the sitemap with pp-sitemap-subarea. Use when adding a dashboard, custom page, or genpage to a model-driven app, building a page on props.dataApi, or wiring a generative page into an app's navigation.
---

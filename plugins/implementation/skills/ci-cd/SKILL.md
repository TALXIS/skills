---
name: ci-cd
description: Sets up GitHub Actions CI/CD for a TALXIS repository — a build workflow validating every pull request, a branch ruleset protecting main, and OIDC-federated deployment of the Package Deployer package to a test environment with no stored secrets beyond identifiers. Use when asked to set up CI/CD, pipelines, GitHub Actions, branch protection, automated deployment, or workload identity federation for a TALXIS project.
---
...
[references/branch-ruleset.md](references/branch-ruleset.md). Keep the ruleset `id`
...
[references/application-user.md](references/application-user.md).
...
[references/workflows.md](references/workflows.md) into `.github/workflows/`,
...
in [references/branch-ruleset.md](references/branch-ruleset.md). Broken solutions

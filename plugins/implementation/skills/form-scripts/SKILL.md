---
name: form-scripts
description: Creates a TypeScript script library web resource with txc, wires it into the UI solution, and registers form onload/onchange event handlers. Use when adding client-side scripting to a form — onLoad or onChange logic, field validation, or a JavaScript web resource in a TALXIS workspace.
---

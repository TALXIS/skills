...
| `acceptance-tests` | turning a user story's acceptance criteria into executable Gherkin `.feature` files in the project's companion tests repo |
...
Feature-file and tests-repo conventions live in
